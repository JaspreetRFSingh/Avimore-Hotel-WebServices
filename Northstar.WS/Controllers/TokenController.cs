...
namespace Northstar.WS.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        private readonly RoleManager<UserRoleDTO> _roleManager;
        ...
        private async Task<AuthenticationTicket> CreateTicketAsync(OpenIdConnectRequest request, UserDTO user, string[] roles)
        {
            ...
            ticket.SetScopes(OpenIddict.Abstractions.OpenIddictConstants.Scopes.Roles);
